...
esn = MyEchoStateNetwork(num_inputs=num_inputs, num_outputs=28, reservoir_size=200, spectral_radius=0.95, sparsity=0.01, noise=0.001, teacher_forcing=True, output_activation=identity_func, inverse_output_activation=identity_func, random_state=42, verbose=False)
...
def train_and_evaluate_esn(reservoir_size, spectral_radius, sparsity, noise):
    esn = MyEchoStateNetwork(num_inputs=num_inputs, num_outputs=28,
...
# Accuracy : 0.9559
# Precision: 0.9573106782596379
# , Recall: 0.9559392676391784,
#  F1 Score: 0.9559655182362645